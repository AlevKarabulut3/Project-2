...
var actorChars = {
  ...
  "=": Lava, "|": Lava, "v": Lava,"w": Lava, "f": Lava,
  "s": Spike,
  "p": Portal,
  "q": Portal2,
};
...
Spike.prototype.act = function(step1) {
  return 1;
};
...
Portal2.prototype.act = function(step) {
  this.wobble += step * wobbleSpeed;
  var wobblePos = Math.sin(this.wobble) * wobbleDist;
  this.pos = this.basePos.plus(new Vector(0, wobblePos));
};
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  if (type == "portal") {
    this.player.pos = new Vector(50, 22);
  }

if (type == "portal2") {
  this.player.pos = new Vector(103, 20);
}
